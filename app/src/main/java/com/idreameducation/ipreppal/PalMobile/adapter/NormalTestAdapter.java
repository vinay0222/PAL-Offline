...
public class NormalTestAdapter extends RecyclerView.Adapter {
    ...
    public NormalTestAdapter(Context context, ArrayList<HashMap<Integer, String[]>> contentArrayList, ArrayList<HashMap<String, String>> questionsArrayList, RecyclerView mRecyclerView, String selectedLanguage, String submit, String submitTest, String imageInternet, String lastMessage) {
        ...
        if (viewHolderValue instanceof ViewItem) {
            ...
            try {
                ...
                if (Util.getScreenOrientation(context) == Configuration.ORIENTATION_LANDSCAPE) {
                    viewHolder.parentLayout.setLayoutParams(new RelativeLayout.LayoutParams(ViewGroup.LayoutParams.MATCH_PARENT, ViewGroup.LayoutParams.MATCH_PARENT));
                    LinearLayout.LayoutParams params = new LinearLayout.LayoutParams(context.getResources().getDisplayMetrics().widthPixels / 3, ViewGroup.LayoutParams.MATCH_PARENT);
