...
public class ArcProgress extends View {
    ...
    public ArcProgress(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        min_size = (int) Util.dp2px(getResources(), 100);
        default_text_size = Util.sp2px(getResources(), 40);
        default_suffix_text_size = Util.sp2px(getResources(), 15);
        default_suffix_padding = Util.dp2px(getResources(), 4);
        default_suffix_text = "%";
        default_bottom_text_size = Util.sp2px(getResources(), 10);
        default_stroke_width = Util.dp2px(getResources(), 4);
    ...
    public void setProgress(float progress) {
        this.progress = progress;//Float.valueOf(new DecimalFormat("#.##").format(progress));
    ...
    protected void onDraw(Canvas canvas) {
        ...
        if (!TextUtils.isEmpty(text)) {
            ...
            canvas.drawText(text, (getWidth() - textPaint.measureText(text)) / 2.0f, textBaseline + 13, textPaint);
