...
public class ReportsTopicWiseVideoRepository {

    private final String DB_NAME = "db_Content";

    private final ContentDatabase reportsTopicWiseVideoDatabase;
    private final Global global;
    private List<ReportsTopicWiseVideoModel> list;

    public ReportsTopicWiseVideoRepository(Context context) {
