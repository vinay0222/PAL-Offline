...
public class UnzipEpub {
    ...
    public void Unzip(Uri file1) {
        final Uri inputEpub = file1;

        File src = new File(String.valueOf(file1));
        ...
        try (ZipInputStream zipInputStream = new ZipInputStream(new FileInputStream(String.valueOf(inputEpub)))) {
