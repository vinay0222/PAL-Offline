...
public class PalReportsVideoFragment extends Fragment {
    ...
    public PalReportsVideoFragment(String subject, ArrayList<HashMap<String, Object>> mainArrayList, ArrayList<String> dateArrayList, ArrayList<String> nameArrayList, String type) {
