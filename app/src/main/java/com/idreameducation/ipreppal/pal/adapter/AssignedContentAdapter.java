...
public class AssignedContentAdapter extends RecyclerView.Adapter {

    private static final int TYPE_ITEM = 0;
    private AssignedContentAdapter.OnItemClickListener clickListener;
    private Global global;
    private Context context;
    private ArrayList<HashMap<String, Object>> assignedContentArrayList;

    public AssignedContentAdapter(Context context, ArrayList<HashMap<String, Object>> assignedContentArrayList) {
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup viewGroup, int viewType) {
        ...
        return new AssignedContentAdapter.ViewItem(view);
    }
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder viewHolderValue, final int position) {
        if (viewHolderValue instanceof AssignedContentAdapter.ViewItem) {
            final AssignedContentAdapter.ViewItem viewHolder = (AssignedContentAdapter.ViewItem) viewHolderValue;
            ...
            boolean isOpened = (boolean) assignedContentArrayList.get(position).get("isOpened");
            if (isOpened) {
    ...
    public void SetOnItemClickListener(final AssignedContentAdapter.OnItemClickListener itemClickListener) {
