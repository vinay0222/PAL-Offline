...
public class HomeBooksAdapter extends RecyclerView.Adapter {
    ...
    public HomeBooksAdapter(Context context, ArrayList<HashMap<String, Object>> booksArrayList, int positionSelected) {
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        if (viewType == TYPE_ITEM) {
            View view = LayoutInflater.from(parent.getContext())
                    .inflate(R.layout.iprep_row_books_list, parent, false);
    ...
    public void onBindViewHolder(@NonNull RecyclerView.ViewHolder holder, int position) {
        if (holder instanceof ViewItem) {
            ...
            new Handler().postDelayed(new Runnable() {
                @Override
                public void run() {
                    Glide.with(context).load(iconLoad).transition(DrawableTransitionOptions.withCrossFade()).
