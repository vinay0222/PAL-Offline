...
public class DiagonosticTestAdapter extends RecyclerView.Adapter {
    ...
    public DiagonosticTestAdapter(Context context, ArrayList<HashMap<Integer, String[]>> contentArrayList, ArrayList<HashMap<String, String>> questionsArrayList, RecyclerView mRecyclerView, String selectedLanguage, int height, String submit, String submitTest, String imageInternet, String lastMessage) {
    ...
    public boolean equals(Object o) {
        ...
        DiagonosticTestAdapter that = (DiagonosticTestAdapter) o;
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup viewGroup, int viewType) {
        if (viewType == TYPE_ITEM) {
            ...
            return new DiagonosticTestAdapter.ViewItem(view);
        }
        return null;
    }
    ...
    String slowInternetText="Slow Internet Connection";
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder viewHolderValue, @SuppressLint("RecyclerView") final int position) {
        if (viewHolderValue instanceof DiagonosticTestAdapter.ViewItem) {
            final DiagonosticTestAdapter.ViewItem viewHolder = (DiagonosticTestAdapter.ViewItem) viewHolderValue;
            try {

                if(Util.getSelectedLanguage(context).equals("hindi")) slowInternetText="इंटरनेट कनेक्शन धीमा है।";
                else slowInternetText="Slow Internet Connection";
...
//                        String image = "https://download.iprep.in/super_app_content/assessment_images/"+questionsArrayList.get(position).get("option1").replace(" ","");
                ...
                if (questionsArrayList.get(position).get("type2").equalsIgnoreCase("Text")) {
                    ...
                    if (!Util.isOfflineMode(context)) {
//                        File file = new File(Util.getSDCardPath(context) + "/.iDream_content/AssessmentImages_"+Util.getSelectedLanguage(context).toLowerCase()+"/Class" + Util.getSelectedClass(context) + "/" + questionsArrayList.get(position).get("option2"));
//                        Uri uri = Uri.fromFile(file);
...
//                        String image = "https://download.iprep.in/super_app_content/assessment_images/"+questionsArrayList.get(position).get("option4").replace(" ","");
                        ...
                        viewHolder.imageViewOption4FullImage.setOnClickListener(new View.OnClickListener() {
                            ...
                            public void onClick(View view) {
                                Util.preventTwoClick(view);
//                                global.setFullImage(Util.getSDCardPath(context) + "/.iDream_content/AssessmentImages_"+Util.getSelectedLanguage(context).toLowerCase()+"/Class" + Util.getSelectedClass(context) + "/" + questionsArrayList.get(position).get("option4"));
...
//                viewHolder.textViewSubmit.setVisibility(View.VISIBLE);
                ...
                viewHolder.textViewSubmit.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View view) {
                        Util.preventTwoClick(view);
                        ((DiagonosticTestActivity) context).finalSubmition();
                    }
                });
                viewHolder.textViewOption1.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View view) {
                        Util.preventTwoClick(view);
                        boolean exists = true;
                        if(!((DiagonosticTestActivity)context).restoreQuestionHashMap.containsKey(position+"-"+1)){
                            optionOneClick(position, "Text");
                            ((DiagonosticTestActivity)context).restoreQuestionHashMap.put(position+"-"+1, true);
                            exists = false;
                        }
                        for (Map.Entry<String, Boolean> entry :((DiagonosticTestActivity)context).restoreQuestionHashMap.entrySet()) {
                            ...
                            if(key.equals(position+"-"+1)){
                                if(exists){
                                    if(value){
                                        ...
                                        if(((DiagonosticTestActivity)context).pos == questionsArrayList.size()){
                                            ((DiagonosticTestActivity)context).pos = ((DiagonosticTestActivity)context).pos - 1;
                                        }
                                    }else{
                                        optionOneClick(position, "Text");
                                        entry.setValue(true);
                ...
                viewHolder.textViewOption2.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View view) {
                        Util.preventTwoClick(view);
                        boolean exists = true;
                        if(!((DiagonosticTestActivity)context).restoreQuestionHashMap.containsKey(position+"-"+2)){
                            optionTwoClick(position, "Text");
                            ((DiagonosticTestActivity)context).restoreQuestionHashMap.put(position+"-"+2, true);
                            exists = false;
                        }
                        for (Map.Entry<String, Boolean> entry :((DiagonosticTestActivity)context).restoreQuestionHashMap.entrySet()) {
                            String key = entry.getKey();
                ...
                viewHolder.textViewOption3.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View view) {
                        Util.preventTwoClick(view);
                        boolean exists = true;
                        if(!((DiagonosticTestActivity)context).restoreQuestionHashMap.containsKey(position+"-"+3)){
                            optionThirdClick(position, "Text");
                            ((DiagonosticTestActivity)context).restoreQuestionHashMap.put(position+"-"+3, true);
                            exists = false;
                        }
                        for (Map.Entry<String, Boolean> entry :((DiagonosticTestActivity)context).restoreQuestionHashMap.entrySet()) {
                            String key = entry.getKey();
                ...
                viewHolder.textViewOption4.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View view) {
                        Util.preventTwoClick(view);
                        boolean exists = true;
                        if(!((DiagonosticTestActivity)context).restoreQuestionHashMap.containsKey(position+"-"+4)){
                            optionFourthClick(position, "Text");
                            ((DiagonosticTestActivity)context).restoreQuestionHashMap.put(position+"-"+4, true);
                            exists = false;
                        }
                        for (Map.Entry<String, Boolean> entry :((DiagonosticTestActivity)context).restoreQuestionHashMap.entrySet()) {
                            String key = entry.getKey();
                        ...
                        switch (i) {
                            case 0:
                                if (questionsArrayList.get(position).get("type1").equalsIgnoreCase("Text")) {
                                    ...
                                    viewHolder.textViewOption1.setCompoundDrawablesWithIntrinsicBounds(R.mipmap.a_option_selected, 0, 0, 0);
                                    viewHolder.textViewOption2.setCompoundDrawablesWithIntrinsicBounds(R.drawable.option_b_drawable, 0, 0, 0);
                                    viewHolder.textViewOption3.setCompoundDrawablesWithIntrinsicBounds(R.drawable.option_c_drawable, 0, 0, 0);
                                    viewHolder.textViewOption4.setCompoundDrawablesWithIntrinsicBounds(R.drawable.option_d_drawable, 0, 0, 0);
                            ...
                            case 1:
                                ...
                                if (questionsArrayList.get(position).get("type1").equalsIgnoreCase("Text")) {
                                    ...
                                    viewHolder.textViewOption1.setCompoundDrawablesWithIntrinsicBounds(R.drawable.option_a_drawable, 0, 0, 0);
                                    viewHolder.textViewOption2.setCompoundDrawablesWithIntrinsicBounds(R.mipmap.b_option_selected, 0, 0, 0);
                                    viewHolder.textViewOption3.setCompoundDrawablesWithIntrinsicBounds(R.drawable.option_c_drawable, 0, 0, 0);
                                    viewHolder.textViewOption4.setCompoundDrawablesWithIntrinsicBounds(R.drawable.option_d_drawable, 0, 0, 0);
                            ...
                            case 2:
                                if (questionsArrayList.get(position).get("type1").equalsIgnoreCase("Text")) {
                                    ...
                                    viewHolder.textViewOption1.setCompoundDrawablesWithIntrinsicBounds(R.drawable.option_a_drawable, 0, 0, 0);
                                    viewHolder.textViewOption2.setCompoundDrawablesWithIntrinsicBounds(R.drawable.option_b_drawable, 0, 0, 0);
                                    viewHolder.textViewOption3.setCompoundDrawablesWithIntrinsicBounds(R.mipmap.c_option_selected, 0, 0, 0);
                                    viewHolder.textViewOption4.setCompoundDrawablesWithIntrinsicBounds(R.drawable.option_d_drawable, 0, 0, 0);
                            ...
                            case 3:
                                if (questionsArrayList.get(position).get("type1").equalsIgnoreCase("Text")) {
                                    ...
                                    viewHolder.textViewOption2.setCompoundDrawablesWithIntrinsicBounds(R.drawable.option_b_drawable, 0, 0, 0);
                                    viewHolder.textViewOption3.setCompoundDrawablesWithIntrinsicBounds(R.drawable.option_c_drawable, 0, 0, 0);
                                    viewHolder.textViewOption4.setCompoundDrawablesWithIntrinsicBounds(R.mipmap.d_option_selected, 0, 0, 0);
    ...
    private void moveToNextQuestion(final int position) {
        try {
            if (position + 1 != questionsArrayList.size()) {
                DiagonosticTestAdapter.ViewItem viewHolder = (ViewItem) mRecyclerView.findViewHolderForAdapterPosition(position);
                ...
                try {
                    ...
                    ((DiagonosticTestActivity) context).checkItsLastQuestion();
...
//                            viewHolder.textViewSubmit.requestFocus();
    ...
    private void restoreToOriginalQuestion(int position, String option) {
        ...
        trackArrayList.get(position).put("Status", "unattempted");
        ...
        ((DiagonosticTestActivity) context).setTextOnQuestionAttampted(count);
        ((DiagonosticTestActivity) context).setAttemptedQ(count);
        ((DiagonosticTestActivity) context).setYetToAttemptQ(questionsArrayList.size() - count);
        ((DiagonosticTestActivity) context).removeAttempt(position);
        ((DiagonosticTestActivity) context).checkSkippedQ(position, 1);
        ((DiagonosticTestActivity) context).refreshQuestionsListingAdapter();
//        ((DiagonosticTestActivity) context).updateNextQuestionButtonText(1, position);
        ((DiagonosticTestActivity) context).checkItsLastQuestion();
        notifyDataSetChanged();
    }
    ...
    private void optionOneClick(int position, String type) {
        ...
        ((DiagonosticTestActivity) context).setAttemptedQ(count);
        ((DiagonosticTestActivity) context).setYetToAttemptQ(questionsArrayList.size() - count);
        ((DiagonosticTestActivity) context).attemptedQMap.add(position);
        ((DiagonosticTestActivity) context).checkSkippedQ(position, 1);
        ((DiagonosticTestActivity) context).refreshQuestionsListingAdapter();
//        ((DiagonosticTestActivity) context).updateNextQuestionButtonText(0, position);
