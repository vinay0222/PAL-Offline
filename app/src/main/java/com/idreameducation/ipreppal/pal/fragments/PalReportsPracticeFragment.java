...
public class PalReportsPracticeFragment extends Fragment {
    ...
    public PalReportsPracticeFragment(String subject, ArrayList<HashMap<String, Object>> mainArrayList, ArrayList<String> dateArrayList,ArrayList<String> nameArrayList, String type) {
