package com.idreameducation.ipreppal.deviceIdService;
...
import com.idreameducation.ipreppal.deviceIdService.impl.OAIDFactory;
...
/**
 * 设备标识符工具类，建议使用{@link com.mondor.imeidemo.DeviceIdentifier}代替
 *
...
public final class DeviceID implements IGetter {
     ...
     *
     * @param context 上下文
     * @see #getOAID(Context, com.mondor.imeidemo.IGetter)
     */
